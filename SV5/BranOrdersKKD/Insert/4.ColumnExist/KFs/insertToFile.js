...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {ItemsInOrder : LocalCoumnItemsInOrder,CustomerData : LocalCoumnCustomerData,OrderData : LocalCoumnOrderData,AddOnData : LocalCoumnAddOnData,CheckOutData : LocalCoumnCheckOutData};
