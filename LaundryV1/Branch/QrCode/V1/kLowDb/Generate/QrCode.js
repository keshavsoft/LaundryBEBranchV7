...
let StartFunc = ({ inBranch, inId }) => {
    ...
    if (Object.keys(LocalIdByOrderData.CustomerData).length === 0) {
        LocalReturnData.KReason = "No CustomerData in Order";
        return LocalReturnData;
    };
    LocalBookingData.BookingData.CustomerData = LocalIdByOrderData.CustomerData;
    if (Object.keys(LocalIdByOrderData.OrderData).length === 0) {
        LocalReturnData.KReason = "No OrderData in Order";
        return LocalReturnData;
    };
