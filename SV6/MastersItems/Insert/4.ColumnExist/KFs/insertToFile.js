...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {Category : LocalCoumnCategory,ItemName : LocalCoumnItemName,Pcs : LocalCoumnPcs,WashType : LocalCoumnWashType,DryWashRate : LocalCoumnDryWashRate};
