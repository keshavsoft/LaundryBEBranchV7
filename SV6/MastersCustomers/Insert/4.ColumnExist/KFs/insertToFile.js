...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {MastersCustomers : LocalCoumnMastersCustomers,Mobile : LocalCoumnMobile,DOB : LocalCoumnDOB,GSTNumber : LocalCoumnGSTNumber,City : LocalCoumnCity,Occupation : LocalCoumnOccupation,CompanyName : LocalCoumnCompanyName,BranchName : LocalCoumnBranchName};
